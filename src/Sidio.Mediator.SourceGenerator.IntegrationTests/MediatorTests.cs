...
public sealed class MediatorTests
{
    ...
    public async Task DefaultRequest()
    {
        ...
        serviceCollection.AddMediatorRequestHandlers(typeof(MediatorTests));
    ...
    public async Task DefaultRequestWithValidation(string input, bool expectedResult)
    {
        ...
        serviceCollection.AddMediatorRequestHandlers(typeof(MediatorTests)).AddMediatorValidation(typeof(MediatorTests));
        serviceCollection.AddMediatorService();
